...
# 9 "lcd16x2_driver.c" 2


void lcd_init() {
    TRISB = 0;
    _delay((unsigned long)((15)*(40000000UL/4000.0)));
    lcd_command(0x02);
    lcd_command(0x28);
    lcd_command(0x01);
    lcd_command(0x0c);
...
void lcd_command(unsigned char cmd ) {
    ...
    __nop();
    LATB1 = 0;
    _delay((unsigned long)((1)*(40000000UL/4000.0)));
    LATB = (LATB & 0x0f) | (cmd<<4);
    LATB1 = 1;
    __nop();
    LATB1 = 0;
    _delay((unsigned long)((3)*(40000000UL/4000.0)));
}
